...
def shell():
	...
	print ((results.download / 1000.0 / 1000.0) / args.units[1])
	download = str((results.download / 1000.0 / 1000.0) / args.units[1])
	upload = str((results.upload / 1000.0 / 1000.0) / args.units[1])

	ping = str(results.ping)


	fields=[str(tm.strftime('%d-%m %H:%M')),ping+ " ms ", download," ",str(results.server) ]
